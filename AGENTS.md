# Agent Operating Instructions for promptquarantine

This file defines how AI agents and human maintainers should work in `promptquarantine`.

## Project Context

- Project: `promptquarantine`
- Repository: ``
- Primary maintainer: ``
- Default branch: ``
- Package manager: ``
