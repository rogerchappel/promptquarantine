...
Replace this section with the supported versions for `promptquarantine`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `promptquarantine` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in promptquarantine.
